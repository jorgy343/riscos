...
mod tests {
    ...
    fn setup_page_tables() -> (PageTable, *const PageTable, *const PageTable) {
        ...
        // Create a mapping for virtual page 0x0012_3456 -> physical page 0x00AB_CDEF.
        // vpn2 = 0x0123 (291), vpn1 = 0x0056 (86), vpn0 = 0x0056 (86)
        ...
        leaf_entry.set_ppn(PhysicalPageNumber::from_raw_physical_page_number(0x00AB_CDEF));
    ...
    fn test_translate_valid_address() {
        ...
        // Construct a virtual address with:
        // vpn2 = 0x0123, vpn1 = 0x0056, vpn0 = 0x0056, offset = 0x0ABC
        let virtual_address = (0x0123u64 << 30) | (0x0056u64 << 21) | (0x0056u64 << 12) | 0x0ABC;
        
        // Expected physical address: physical page 0x00AB_CDEF with offset 0x0ABC.
    ...
    fn test_translate_invalid_root_entry() {
        ...
        let result = translate_virtual_address(&root, virtual_address);
        assert_eq!(result, 0, "Translation should fail with invalid root entry.");
    }
    ...
    fn test_translate_invalid_level1_entry() {
        ...
        assert_eq!(result, 0, "Translation should fail with invalid level 1 entry.");
    }
    ...
    fn test_translate_invalid_level0_entry() {
        ...
        assert_eq!(result, 0, "Translation should fail with invalid level 0 entry.");
    }
    ...
    fn test_translate_different_offsets() {
        ...
        assert_eq!(result_1, expected_physical_address_1, "Translation with zero offset failed.");
        assert_eq!(result_2, expected_physical_address_2, "Translation with maximum offset failed.");
    }
}
